              ...
              <div class="row pt-2 pb-2 " >
                <div class="col-md-8">
                  <div class="embed-responsive embed-responsive-4by3">
                    <iframe class="embed-responsive-item h-100 border border-danger" src="{camera_lane_1}video"></iframe>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                      <img src="<?=base_url()?>assets/images/green-removebg-preview.png" id="traffic_light_lane_1" class="img img-responsive" style="max-height: 280px; width: 110px;">
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="container">
                       ...
                       <div class="col-md-12">
                         <span id="timer" class="timer">0139</span>
                         <br>
    ...
    <script type="text/javascript">
      ...
      setTimeout(function(){
        $.ajax({url: link+"/end_point", success: function(result){
          ...
          data[0].value = res.lane_1_traffic;
