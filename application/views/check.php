...
<div style="text-align:center">
	<form action="https://www.ipaddressguide.com/ping" method="post">
		<p style="background:#fff;border:1px solid #99A8AE;width:180px;padding:5px 5px 5px 5px;font-size:11px;font-family:'Trebuchet MS',Arial,Sans-serif;">
			<a href="https://www.ipaddressguide.com" target="_blank"><img src="https://www.ipaddressguide.com/images/ipaddressguide.gif" alt="Online Ping Utility Tool for IPv4 Address | IP AddressGuide" border="0" width="120" height="12" /></a><br />
			<b>IPv4 Ping <br><small>Free online tool to ping an IPv4 address or host name</small></b><br /><br />
			<label>Host</label><br />
