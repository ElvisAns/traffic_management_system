        ...
        <section class="main-banner" class="pt-n5">
          <div class="container-fluid">
                ...
                <div class="col-md-4">
                  <div class="row">
                    <div class="col-md-12 pb-2 pt-4">
                      <h5 class="text-white">STATE OF LANE 1</h5>
                    </div>
                    <div class="col-md-4">
                      <img src="<?=base_url()?>assets/images/all-removebg-preview.png" id="traffic_light_lane_1" class="img img-responsive" style="max-height: 280px; width: 110px;">
                    </div>
                    ...
                    <div class="col-md-4">
                      <div class="container">
                        <div class="col-md-12 pb-4">
                         <iframe src="http://free.timeanddate.com/clock/i7oiedni/n119/szw110/szh110/hocddd/hbw0/hfc000/cf100/hgr0/hcc00f/hcw10/fav0/fiv0/mqcfff/mql15/mqw8/mqd100/mhcfff/mhl15/mhw4/mhd100/mmcf00/mmd70/hhcff9/hmcff9" frameborder="0" width="110" height="110"></iframe>

                       </div>

                       <div class="col-md-12">
                         <span id="timer1" class="timer">0000</span>
                         <br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="container">
                     ...
                     <div class="col-md-12">
                       <span id="timer2" class="timer">0000</span>
                       <br>
                       <span class ="text-white text-right">seconds</span>
                     </div>
            ...
            <div class="col-md-4">
              <div class="row">
                <div class="col-md-12 pb-2 pt-4">
                  <h5 class="text-white">STATE OF LANE 3</h5>
                </div>
                <div class="col-md-4">
                  <img src="<?=base_url()?>assets/images/all-removebg-preview.png" id="traffic_light_lane_3" class="img img-responsive" style="max-height: 280px; width: 110px;">
                </div>
                ...
                <div class="col-md-4">
                  <div class="container">
                   ...
                   <div class="col-md-12">
                     <span id="timer3" class="timer">0000</span>
                     <br>
                     <span class ="text-white text-right">seconds</span>
                   </div>
...
<div id="sidebar">
  ...
  <script type="text/javascript">
    ...
    Plotly.newPlot('chart-container1', data1, layout);
    Plotly.newPlot('chart-container2', data2, layout);
    Plotly.newPlot('chart-container3', data3, layout);
    ...
    setTimeout(function(){
      $.ajax({url: link+"/end_point", success: function(result){
        ...
        data1[0].value = res.lane_1_traffic;
        data2[0].value = res.lane_2_traffic;
        data3[0].value = res.lane_3_traffic;
        ...
        $("#timer1").html(delay>1000?delay:delay>100?"0"+delay:delay>10?"00"+delay:"000"+delay);
        $("#timer2").html(delay>1000?delay:delay>100?"0"+delay:delay>10?"00"+delay:"000"+delay);
        $("#timer3").html(delay>1000?delay:delay>100?"0"+delay:delay>10?"00"+delay:"000"+delay);

        var src_lane1 = res.lane_1_light_state;
        var src_lane2 = res.lane_2_light_state;
        var src_lane3 = res.lane_3_light_state;


        $("#traffic_light_lane_1").attr("src", src_images[src_lane1]) ;
        $("#traffic_light_lane_2").attr("src", src_images[src_lane2]) ;
        $("#traffic_light_lane_3").attr("src", src_images[src_lane3]) ;
