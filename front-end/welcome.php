  ...
  <div id="wrapper">
    ...
    <div id="main">
      <div class="inner">
        ...
        <header id="header">
          <div class="logo">
            <a href="dashboard">SMART TRAFFIC </a>
          </div>
        </header>
        ...
        <div class="inner">
          ...
          <nav id="menu">
            <ul>
              ...
              <li><a href="dashboard/logs">CAR DETECTION LOGS</a></li>
              <li><a href="dashboard/flow">FLOW SETTINGS</a>(voice)</li>
              <li><a href="dashboard/licence">LICENCES RECORDS</a></li>
              <li>
                <span class="opener">LANE MONITORING</span>
                <ul>
                  <li><a href="dashboard/monitor">ALL</a></li>
                  <li><a href="dashboard/lane/lane1">LANE 1</a></li>
                  <li><a href="dashboard/lane/lane2">LANE 2</a></li>
                  <li><a href="dashboard/lane/lane3">LANE 3</a></li>
                </ul>
              </li>
              <li>
                <li><a href="dashboard/get_report">PRINT REPORT</a></li>
                <li><a href="dashboard/check">SYSTEM CHECK</a>(status)</li>
              </ul>
            </nav>
